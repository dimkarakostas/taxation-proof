...
\paragraph{Tax-Auditing Extension}\label{subsec:tax-authority-proto}
...
\myhalfbox{Asset Taxation Protocol $\taxationProto$}{white!40}{white!10}{
...
\myhalfbox{Address Verification Protocol $\taxationAddressProto$}{white!40}{white!10}{
    Public data: $h$, $(y_i, l_i)$ for $i \in [1, n]$
